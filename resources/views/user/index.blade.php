    ...
    <div class="container mt-5">
      <div class="card">
        <div class="card-header text-right">
          <a href="{{ route('createUsers') }}" class="btn btn-primary btn-sm" role="button">
            <i class="bi bi-file-earmark-plus"></i> Add
          </a>
          <a href="{{ route('user.trash') }}" class="btn btn-primary btn-sm" role="button">
            ...
            <table class="table table-hover table-bordered" id="data-table">
              ...
              <tbody>
                ...
                <tr class="bg-dark">
                  ...
                  <td>
                    @if ($user->img)
                    <img src="{{ asset($user->img) }}" alt="{{ $user->name }}" width="100" class="img-fluid">
                    @endif
                  </td>
                  <td>{{ $user->name }}</td>
                  <td>{{ $user->username }}</td>
